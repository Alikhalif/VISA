    ...
    <script>
        ...
        form.addEventListener('submit', function(e){
            ...
            if(validate == true){
                ...
                .then(mydata => {
                    console.log(mydata);
                    sessionStorage.setItem("userId",mydata[0].id);
                    sessionStorage.setItem("nom",mydata[0].nom);
                    sessionStorage.setItem("prenom",mydata[0].prenom);
                    sessionStorage.setItem("token",mydata[0].token);
